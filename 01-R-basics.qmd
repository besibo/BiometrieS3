# R et RStudio : les bases {#sec-bases}
...
<br>
<br>
- `RStudio`, ouvrir cela : ![](images/RStudio-Ball.png)
...
:::{.callout-warning}
## Les risques du "copier-coller" [{{< fa clipboard regular >}}]{style="color: orange"}
...
:::{.callout-important}
## Où sauvegarder vos scripts ? [{{< fa floppy-disk regular >}}]{style="color:red"}
...
:::{.callout-warning}
## Erreur ou avertissement ? {{< fa bomb >}} ou {{< fa triangle-exclamation >}} ?
