...
Une bonne maîtrise des éléments présentés dans ce chapitre est indispensable pour aborder sereinement les chapitres suivants, à commencer par le @sec-dataset, qui présente un jeu de données que nous explorerons en détail un peu plus tard. Lisez donc attentivement ce chapitre et faites bien tous les exercices demandés. 
...
:::{.callout-important}
Avant d'aller plus loin, rendez-vous sur [le site de DataCamp](https://www.datacamp.com/) et créez-vous un compte gratuit.
::: -->
...
2. [Téléchargez et installez `RStudio`](https://posit.co/download/rstudio-desktop/)
...
## Comment exécuter du code ? {#sec-code}
...
Allez maintenant découvrir [le cours d'introduction à R](https://app.datacamp.com/learn/courses/free-introduction-to-r) sur DataCamp, et cliquez sur les liens des chapitres ci-dessous. Au fur et à mesure de votre travail, notez les termes importants et ce à quoi ils font référence.

- [Chapitre 1 : introduction](https://campus.datacamp.com/courses/free-introduction-to-r/chapter-1-intro-to-basics-1?ex=1)
...
- [Chapitre 2 : vecteurs](https://campus.datacamp.com/courses/free-introduction-to-r/chapter-2-vectors-2?ex=2)
    - Les vecteurs : des collections de valeurs du même type
- [Chapitre 4 : les facteurs](https://campus.datacamp.com/courses/free-introduction-to-r/chapter-4-factors-4?ex=1)
    - Des données catégorielles (et non pas *numériques*) représentées dans `R` sous forme de `factor`s
- [Chapitre 5 : les jeux de données ou `data.frame`](https://campus.datacamp.com/courses/free-introduction-to-r/chapter-5-data-frames?ex=1)
