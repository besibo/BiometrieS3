...
1. faire différents types de graphiques exploratoires avec le package `ggplot2` {{< fa chart-line >}} {{< fa chart-gantt >}} {{< fa chart-column >}} {{< fa chart-area >}}
...
2. les nuages de points : la variable d'intérêt est placée sur l'axe des `y`. L'axe des `x` porte soit un simple numéro d'indice pour chaque observation, soit une unique valeur sans importance.
