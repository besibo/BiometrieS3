...
Vous pouvez maintenant accéder à un nouvel objet géométrique, `geom_mosaic()`, dont l'utilisation est un peu différente de celle que nous avons vu jusqu'ici :
